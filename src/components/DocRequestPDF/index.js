            ...
            <View style={{ fontSize: 10 }}>
              ...
              >
                <Text style={{padding: 7, lineHeight: 1.2}}>
                  ...
                  según consta en la Cámara y Comercio adjunta, dueña del vehículo de PLACAS: ___{request?.placa}___, No. de VIN:__{request?.vin}__, No. de CHASIS:__{request?.chasis}__, TIPO: ___{request?.tipo}___, MARCA: ___{request?.marca}___,
                  SERVICIO: ___{request?.servicio}___, LICENCIA DE TRÁNSITO NO. ___{request?.licenciaTransito}___, En condición de propietario
              ...
              >
                <Text style={{padding: 7, lineHeight: 1.2}}>
                  ...
                  el señor(a): ___{request?.primerApellidoPersonAuth} {request?.segundoApellidoPersonAuth} {request?.primerNombrePersonAuth} {request?.segundoNombrePersonAuth}___, identificado con la (C.C) (C.E) No. ___{request?.cedulaPersonAuth}___, con 
